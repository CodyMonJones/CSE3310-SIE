...
public class TransactionsWishlistAdapter extends RecyclerView.Adapter<TransactionsWishlistAdapter.ViewHolder> {
    ...
    public TransactionsWishlistAdapter(ArrayList<TransactionsProduct> itemList, Context context,
    ...
    @Override
    public TransactionsWishlistAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.transactions_product_listing, null);
        return new TransactionsWishlistAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final TransactionsWishlistAdapter.ViewHolder holder, final int position) {
